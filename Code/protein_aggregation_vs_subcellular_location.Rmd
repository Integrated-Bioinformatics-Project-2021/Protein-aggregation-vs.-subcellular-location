...
PERCENTAGE OF INTERESTED RESIDUES FOR ALL OF THE GK + FL SIDES
```{r}
GK_analysis_GK_and_FL_groupings = analyse_gate_keeper_residues(GK_analysis$cts_gk_fl_groups_side)
side_string = "GK + FL"
```
...
for (i in 1:length(search_terms)) {
  ...
  pie_plot_sides(counts_side_gk$pos_ct, "negative", region_string, search_terms[i])
