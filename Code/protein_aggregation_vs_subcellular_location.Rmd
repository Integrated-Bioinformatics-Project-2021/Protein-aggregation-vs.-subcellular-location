...
```
##INTERESTED GROUPINGS
Postive charged (positive) --> K <br />
Negative charged (negative) --> R <br />
Uncharged (uncharged) --> D <br />
Special cases (special) --> E <br />
Hydrophobic (hydrophobic) --> S <br />
