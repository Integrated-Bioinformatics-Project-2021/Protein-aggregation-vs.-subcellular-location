...
**plot_normalized_number_APR_regions**: Generates the violin plot for max tango score of all proteins according to their subcellular locations. Red points demonstrate the mean value of the tango score for each subcellular location.
