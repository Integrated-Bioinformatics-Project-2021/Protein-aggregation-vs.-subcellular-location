...
for (i in 1:length(search_terms)) {
  ...
  pie_plot_sides(counts_side_gk_groups$pos_ct, "negative", region_string, search_terms[i]) 
  pie_plot_sides(counts_side_gk_groups$neg_ct, "positive", region_string, search_terms[i])
