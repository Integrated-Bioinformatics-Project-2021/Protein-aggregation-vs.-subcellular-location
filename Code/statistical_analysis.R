...
get_wilcox_test_table <- function(data) {
	...
	write.csv(table_sig_subc_com_prot, file = "C:/Users/wpare/OneDrive/Documenten/Studies 2021-2022/Semester 1/Integrated Bioinformatics Project/table_sig_subc_com_prot.csv")
}
...
plot_ks_test <- function(data) {
	sample1 <- data$Tango_scores[data$Secretory == TRUE]
	sample2 <- data$Tango_scores[data$Secretory == FALSE]
